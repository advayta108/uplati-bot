...
<p align="center">
  <a href="https://www.npmjs.com/package/@advayta108/uplati-sdk/v/1.2.3"><img src="https://img.shields.io/static/v1?label=npm&message=1.2.3&color=CB3837&logo=npm&logoColor=white&style=flat-square" alt="npm 1.2.3" /></a>
...
**TypeScript SDK** for the [«Система город»](https://uplati.ru) service API. Use it to authenticate, read meters, submit readings, fetch receipts, transactions, and manage autopayments.
